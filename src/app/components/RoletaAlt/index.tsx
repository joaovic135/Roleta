...
const RoletaAlt: React.FC = () => {
  ...
  useEffect(() => {
    try {
      ...
      Cookies.set('AltrouletteOptions', JSON.stringify(options), {
        expires: 365,
        path: '/',
        sameSite: 'strict',
      })
  ...
  useEffect(() => {
    // Set needsNewColor to true when text is empty
  ...
  return (
    <div className="min-h-screen bg-gray-100 py-8">
      <Head>
        <title>Roleta Alternativa</title>
